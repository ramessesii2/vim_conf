...
autocmd FileType cpp inoremap <buffer> $ks <C-\><C-O>:read ~/Programs/templates/cpp_config/ks.cpp<CR>
autocmd FileType cpp inoremap <buffer> $simp <C-\><C-O>:read ~/Programs/templates/cpp_config/simp.cpp<CR>
